...
public class AuditDetailAction extends GenericActionSupport {
	...
	public String execute(){
		String method="show audit details action!";
		try {
			...
			audit=auditService.findAuditByPrimaryKey(audit.getId());
