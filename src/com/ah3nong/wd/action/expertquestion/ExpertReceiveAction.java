...
public class ExpertReceiveAction extends GenericActionSupport<Question> {
	private static final long serialVersionUID = 3464779050692890935L;
	...
	public String execute() {
		try {
			...
			//获得问题总数和当前页面的问题列表
			count = questionService.countQuestionsAskForExpert(params);
			List<Question> questionList = questionService.findQuestionsAskForExpert(params);
