...
public class ExpertAskAction extends GenericActionSupport<Question>{

	private static final long serialVersionUID = -81712708620238551L;
	...
	public String execute() {
		try {
			...
			//获得问题列表
			List<Question> questionList = questionService.findQuestionsByUserId(params);
