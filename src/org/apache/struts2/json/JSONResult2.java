/*
 * $Id: JSONResult.java 1307897 2012-03-31 20:39:53Z lukaszlenart $
 *
 ...
 * </pre>
 */
public class JSONResult2 implements Result {

    private static final long serialVersionUID = 8624350183189931165L;

    private static final Logger LOG = LoggerFactory.getLogger(JSONResult2.class);
    ...
    public void execute(ActionInvocation invocation) throws Exception {
        ...
        try {
			...
			StringBuilder str = new StringBuilder("{\"result\":\"").append(resultCode).append("\",\"data\":")
					.append(json);
			...
			str.append("}");
			writeToResponse(response, str.toString(), enableGzip(request));
            /////////////////////////////
