...
<script>
  ...
  if(navigator.userAgent.indexOf("MSIE")>0) {
	...
	window.location.href="m/keyword/add.action";
            return true; 
        }
...
<div id="man_zone">
  ...
  <form method="post" action="add.action" onsubmit="return checkSub();">
  <table class="mytable" cellpadding="0" cellspacing="0" style="margin-top:50px;" width="400px;">
   ...
   ; font-size:14px; font-weight:bold; padding-left:20px;">添加</td>
   </tr>
    <tr>
     <th>关键字名称</th>
        <td colspan="3"><input type="text" id="title" name="keyword.content" 
    ...
    <tr>
     <th>是否开启</th>
        <td colspan="3"><input type="radio" value="T" name="status" checked="checked"/>是 <input type="radio" value="F" name="status"/> 否 <span style="color:#FF0000; font-size:11px" id="checkInfo1"> </span></td>
    </tr>
    <tr>
