...
<div class="footer">
	<div class="footer_zjft">
		...
		<div style="height:68px; ">
			<ul class="olistn">
				<wd:linkList var="links" status="1" />
	...
	<wd:sysData var="copyright" name="copyright" />
	${copyright.content}dd
	<script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/js/51la.js"></script>
	<noscript>
		<a href="http://www.51.la/?15914640" target="_blank"><img alt="&#x6211;&#x8981;&#x5566;&#x514D;&#x8D39;&#x7EDF;&#x8BA1;" src="http://img.users.51.la/15914640.asp" style="border: none" /></a>
	</noscript>
	<br />
	<wd:sysData var="foot" name="foot" />
	${foot.content}
	<br />
	<!--申请友链-->
	<div style="position: absolute;  display: none;height:251px;" id="applybox" class="applybox">
		...
		<div class="urlmainlist">
			...
			网站名：${sitename.content }<br/>
			网站地址：${applicationScope.siteUrl }<br/>
			<!-- 友情链接请联系：<br/>
...
$(document).ready(function() {
	...
	$('#submitlink').click(function(){
		var applyurl="${pageContext.request.contextPath}/link/addLink.action";
			...
			$.post(applyurl,{name:linkname,url:linkurl,status:"0"},
				function(d){
					...
					if(d.result=="success"){
						...
						$('.urlmainlist').append("该链接已经存在，请勿重复申请。如有疑问请与网站管理人员联系。<br/>电话：0518-86226649");
					}
				}
			);
		}
