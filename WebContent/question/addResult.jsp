...
<head>
<wd:sysData var="askTmeInterval" name="askTmeInterval" />
	...
	<div class="info_area">
		<c:choose>
			<c:when test="${msg=='SUCCESS'}">
				<div class="info_con">
					<span class="fon14">您的疑问我们已经收到，专家网友正在积极的为您解答,请耐心等待！<br />您可以点击“返回该问题”对问题进行补充
					</span> <br /> (&nbsp;&nbsp;<span id="jumpTo" style="color: blue">5</span>&nbsp;秒后自动返回该问题页面...)
					<script type="text/javascript">countDown(5,'${pageContext.request.contextPath}/question/${qid}.html');</script>
				</div>
				<div class="info_btn">
					<div class="btn fl" style="margin-top: 26px;">
						<img onclick="window.location.href='${pageContext.request.contextPath}/question/${qid}.html'" style="cursor: pointer" src="${pageContext.request.contextPath}/images/info_02.jpg" width="113"
							height="35" />
					</div>
					<div class="btn fl" style="margin-top: 26px;">
			...
			<c:when test="${msg=='AUDITTING'}">
				<div class="info_con">
					<span class="fon14">您的疑问我们已经收到，审核完成后将会在问题列表显示！<br />
			...
			<c:when test="${msg=='ERROR'}">
				<div class="info_con">
					<span class="fon14">提问失败！操作太频繁，请${askTmeInterval.content }分钟后再进行提问操作。</span>
				</div>
				<div class="info_btn">
					<div class="btn fl" style="margin-top: 26px;">
						<img onclick="window.location.href='${pageContext.request.contextPath}/index.html'" src="${pageContext.request.contextPath}/images/info_03.jpg" style="cursor: pointer" width="113" height="35" />
			...
			<c:when test="${msg=='IMGFAIL'}">
				<div class="info_con">
					<span class="fon14">您上传的图片大小超过1M或格式不正确。</span>
				</div>
				<div class="info_btn">
					<div class="btn fl" style="margin-top: 26px;">
						<img onclick="window.location.href='${pageContext.request.contextPath}/index.html'" src="${pageContext.request.contextPath}/images/info_03.jpg" style="cursor: pointer" width="113" height="35" />
			...
			<c:when test="${msg=='NULLUSER'}">
				<div class="info_con">
					<span class="fon14">您还没有登录，请登录后再进行提问操作。</span>
				</div>
				<div class="info_btn">
					<div class="btn fl" style="margin-top: 26px;">
						<img onclick="window.location.href='${pageContext.request.contextPath}/index.html'" src="${pageContext.request.contextPath}/images/info_03.jpg" style="cursor: pointer" width="113" height="35" />
