...
<body>
	...
	<div class="area">
		...
		<div class="c_leftarea" style="margin-top: 0px;">
			...
			<div class="c_allqus" style="margin-top: 0px;" >
				<div class="sbar">
					...
					<span class="more">共搜到 ${count } 个与<font color="#61A707">${t}</font>相关的知识专题</span>
				</div>
				<!-- 标题开始-->
				<div class="pad6">
					<div class="img_list1">
      ...
      【<a href="${pageContext.request.contextPath}/search/index.action?searchFor=topic&t=${t}">第一页</a>】
      【<a href="${pageContext.request.contextPath}/search/index.action?searchFor=topic&t=${t}&currentPage=${currentPage-1 }">上一页</a>】 
     </s:if>
					<s:else>
      ...
      【<a href="${pageContext.request.contextPath}/search/index.action?searchFor=topic&t=${t}&currentPage=${currentPage+1 }">下一页</a>】 
      【<a href="${pageContext.request.contextPath}/search/index.action?searchFor=topic&t=${t}&currentPage=${countSize }">最末页</a>】
      </s:if>
					<s:else>
